...
export const AddNote = () => {
    ...
    const saveNote = (event) => {
        ...
        // setNote({ title: "", description: "", tag: "default", sBgColor});
    }

    const onChange = (event) => { setNote({ ...note, [event.target.name]: event.target.value }); }
                ...
                <div className="addNote-dialog modal-dialog modal-dialog-centered modal-dialog-scrollable">
                    <div className="addNote-content modal-content">
                        ...
                        <div className="addNote-body modal-body">
                            <textarea id="description" name="description" placeholder="Add note.." onChange={onChange} rows="4"></textarea>
                        </div>
